...
//   routines  : 事業ごとのルーティン業務（SNS運用等） [{ business, platform, detail, frequency, url, accountLabel }]
//                 ・business は "kohomada"|"kinoto"|"fp"|"common" 等の事業タグ
//                 ・platform は見出し（"note"|"Instagram"|"X" 等）
//                 ・detail/frequency/url が未確認のものは追加しない（捏造しない）
