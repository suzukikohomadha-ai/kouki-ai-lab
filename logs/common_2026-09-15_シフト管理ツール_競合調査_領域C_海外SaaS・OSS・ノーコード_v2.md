...
- 事業タグ：common（社長が開発側との間で仲介するお客さま＝店舗事業者向けの案件。お客さまの事業・社名は未確認のため common 扱い。T224 v2の前提と整合）
- 調査担当：リサ（Research & Evidence Analyst）／保存：秘書アイ（タスク T225）
- 調査日／全出典の確認日：2026-09-15
- 状態：Draft v2（2026-09-15 アオイ監査「PASS WITH CONDITIONS」の条件を反映：結論1の過剰一般化を修正／OptaPlanner EOL の記述を表に合わせて限定／Deputy Android の日本語対応を[未確認]に／ヘッダーの事業前提をT224 v2と整合）
- **監査で他情報との食い違いが指摘された料金（社長判断前に必ず公式で再確認）**：Notion Plus「$4／$5」、Microsoft 365 F1「$4」、Homebase「$30／$70／$120」、FormBridge「7,000円〜」。いずれも本調査のスニペット値であり、アオイの知識と一致しない
